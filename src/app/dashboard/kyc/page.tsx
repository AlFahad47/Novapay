            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <motion.button
                  ...
                  type="submit"
                  className="w-full mt-8 py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-[#0095ff] to-[#0061ff] shadow-lg disabled:opacity-50"
                >
...
function StatusCard({ title, desc, icon, color }: any) {
  return (
    ...
    >
      <div className="text-6xl mb-6">{icon}</div>
      <h2 className={`text-3xl font-bold mb-4 ${color}`}>{title}</h2>
      <p className="text-gray-600 dark:text-blue-200 text-lg max-w-md mx-auto">
        {desc}
      </p>
      <button
...
function Section({ title, children }: any) {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
    >
      <h2 className="text-xl font-semibold mb-6 bg-gradient-to-r from-[#0095ff] to-[#0061ff] bg-clip-text text-transparent">
        {title}
      </h2>
      <div className="grid md:grid-cols-2 gap-6">{children}</div>
    </motion.div>
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <input
        ...
        className={`bg-gray-100 dark:bg-blue-900/20 text-gray-800 dark:text-blue-100 border border-gray-300 dark:border-blue-700/40 rounded-lg px-4 py-2 focus:ring-2 focus:ring-[#0095ff] outline-none ${readOnly ? "opacity-60" : ""}`}
      />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-2 md:col-span-2">
      ...
      <textarea
        ...
        required={required}
        rows={2}
        className="bg-gray-100 dark:bg-blue-900/20 text-gray-800 dark:text-blue-100 border border-gray-300 dark:border-blue-700/40 rounded-lg px-4 py-2 outline-none"
      />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <input
        type="file"
        name={name}
        className="bg-gray-100 dark:bg-blue-900/20 text-gray-800 dark:text-blue-100 border border-gray-300 dark:border-blue-700/40 rounded-lg px-4 py-2 file:bg-blue-600 file:text-white file:border-0 file:rounded-md"
      />
    </div>
  );
}
